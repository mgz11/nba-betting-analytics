...
def fetch_odds_from_api(sport: str = "basketball_wnba", regions: str = "us", markets: str = "h2h,spreads,totals"):
    """
    ...
    try:
        ...
        logger.exception("Odds API request timed out")
        return []
    except requests.exceptions.HTTPError:
        logger.exception("Odds API HTTP error: %s", response.text)
        return []
